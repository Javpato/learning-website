...
export const MODULES: Module[] = [
  ...
  },
  {
    ...
    units: [
      ...
      {
        slug: "project-3-seleccion-de-personaje",
        kind: "project",
        pokemon: "blastoise",
        title: {
          es: "Proyecto 3 · Selección de personaje",
          en: "Project 3 · Character Selection",
          fr: "Projet 3 · Sélection de personnage",
        },
        desc: {
          es: "La pantalla de elegir héroe, con listas de diccionarios.",
          en: "The choose-your-hero screen, with lists of dictionaries.",
          fr: "L'écran de choix du héros, avec des listes de dictionnaires.",
        },
      },
      {
        slug: "project-4-inventario-y-tienda",
        kind: "project",
        pokemon: "butterfree",
        title: {
          es: "Proyecto 4 · Inventario y tienda",
          en: "Project 4 · Inventory and Shop",
          fr: "Projet 4 · Inventaire et boutique",
        },
        desc: {
          es: "La tienda de un RPG con dicts, sets y comprensiones.",
          en: "An RPG shop with dicts, sets and comprehensions.",
          fr: "La boutique d'un RPG avec dicts, sets et compréhensions.",
        },
      },
    ],
  },
  {
    ...
    units: [
      ...
      {
        slug: "project-5-registro-de-partidas",
        kind: "project",
        pokemon: "beedrill",
        title: { es: "Proyecto 5 · Registro de partidas", en: "Project 5 · Match Log", fr: "Projet 5 · Journal de parties" },
        desc: {
          es: "Estadísticas de tus partidas, guardadas en JSON.",
          en: "Stats of your matches, saved as JSON.",
          fr: "Stats de tes parties, sauvegardées en JSON.",
        },
      },
    ],
  },
  ...
  },
  {
    ...
    units: [
      {
        slug: "19-construye-tu-propia-app",
        kind: "chapter",
        pokemon: "psyduck",
        title: {
          es: "Construye tu propia app de datos",
          en: "Build Your Own Data App",
          fr: "Construis ta propre app de données",
        },
        desc: {
          es: "CRUD, ids únicos y JSON — el esqueleto de toda app.",
          en: "CRUD, unique ids and JSON — the skeleton of every app.",
          fr: "CRUD, ids uniques et JSON — le squelette de toute app.",
        },
      },
      {
        slug: "project-9-pokedex",
        kind: "project",
        pokemon: "golem",
        title: { es: "Proyecto 9 · Pokédex", en: "Project 9 · Pokédex", fr: "Projet 9 · Pokédex" },
        desc: {
          es: "Una Pokédex CRUD con persistencia en JSON.",
          en: "A CRUD Pokédex with JSON persistence.",
          fr: "Un Pokédex CRUD avec persistance en JSON.",
        },
      },
    ],
  },
