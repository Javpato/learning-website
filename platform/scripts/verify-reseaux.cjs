...
const files = ["delays", "lineCoding", "ipv4", "routing", "arq", "tcp", "networkLab", "networkLanguage", "routingDiscovery", "networkCodeExercises", "bellmanGuide"].map(
...
require("./verify-routing-discovery.cjs");

require("./verify-bellman-guide.cjs");
