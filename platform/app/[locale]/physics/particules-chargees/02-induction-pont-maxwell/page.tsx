...
export const metadata = { title: "Induction and bridge to Maxwell — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  return renderLearnPage({
    ...
    crumbs: physicsThemeCrumbs(
      ...
      "Particules chargées",
      {
        fr: "Induction & pont vers Maxwell",
        en: "Induction & bridge to Maxwell",
        es: "Inducción y puente hacia Maxwell",
      },
    ),
  });
}
