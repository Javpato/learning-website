...
export const metadata = { title: "Differential systems & phase portraits — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  return renderLearnPage({
    ...
    crumbs: mathFmvCrumbs(locale, {
      fr: "Systèmes différentiels & portraits de phase",
      en: "Differential systems & phase portraits",
      es: "Sistemas diferenciales y retratos de fase",
    }),
  });
}
