...
export const metadata = { title: "Partial derivatives & gradient — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  return renderLearnPage({
    ...
    crumbs: mathFmvCrumbs(locale, {
      fr: "Dérivées partielles & gradient",
      en: "Partial derivatives & gradient",
      es: "Derivadas parciales y gradiente",
    }),
  });
}
