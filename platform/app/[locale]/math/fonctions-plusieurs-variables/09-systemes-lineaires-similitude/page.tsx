...
export const metadata = { title: "Linear systems & similarity — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  return renderLearnPage({
    ...
    crumbs: mathFmvCrumbs(locale, {
      fr: "Systèmes linéaires & similitude",
      en: "Linear systems & similarity",
      es: "Sistemas lineales y semejanza",
    }),
  });
}
