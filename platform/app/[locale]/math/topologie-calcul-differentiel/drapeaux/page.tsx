...
const CRUMBS: Record<Locale, { module: string; leaf: string }> = {
  fr: { module: "Topologie & calcul différentiel", leaf: "Drapeaux" },
  es: { module: "Topología y cálculo diferencial", leaf: "Banderas" },
  en: { module: "Topology & differential calculus", leaf: "Flags" },
};

export default function DrapeauxPage({ params }: { params: { locale: string } }) {
