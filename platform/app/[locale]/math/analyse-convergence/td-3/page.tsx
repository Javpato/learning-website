...
export const metadata = { title: "TD 3 — Sequences of functions — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  return renderLearnPage({
    ...
    crumbs: mathAnalyseCrumbs(locale, {
      fr: "TD 3 — Suites de fonctions",
      en: "TD 3 — Sequences of functions",
      es: "TD 3 — Sucesiones de funciones",
    }),
  });
}
