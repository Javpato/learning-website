...
export const metadata = { title: "Parameter-dependent integrals — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  return renderLearnPage({
    ...
    crumbs: mathAnalyseCrumbs(locale, {
      fr: "Intégrales à paramètre",
      en: "Parameter-dependent integrals",
      es: "Integrales con parámetro",
    }),
  });
}
