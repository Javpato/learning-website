...
export const metadata = { title: "Power series expansions — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  return renderLearnPage({
    ...
    crumbs: mathAnalyseCrumbs(locale, {
      fr: "Développements en série entière",
      en: "Power series expansions",
      es: "Desarrollos en serie entera",
    }),
  });
}
