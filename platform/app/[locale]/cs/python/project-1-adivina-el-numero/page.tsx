...
export const metadata = { title: "Proyecto 1 — Adivina el número — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  const unit = unitBySlug("project-1-adivina-el-numero");
    ...
    <>
      <Breadcrumbs
        items={[
          ...
          { label: unit ? pick(unit.title, locale) : "Proyecto 1 · Adivina el número" },
        ]}
      />
