...
export const metadata = { title: "Módulos y biblioteca estándar — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  const unit = unitBySlug("10-modulos-y-biblioteca-estandar");
    ...
    <>
      <Breadcrumbs
        items={[
          ...
          { label: unit ? pick(unit.title, locale) : "10 · Módulos y biblioteca estándar" },
        ]}
      />
