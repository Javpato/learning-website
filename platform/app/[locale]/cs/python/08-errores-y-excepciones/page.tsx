...
export const metadata = { title: "Errores y excepciones — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  const unit = unitBySlug("08-errores-y-excepciones");
    ...
    <>
      <Breadcrumbs
        items={[
          ...
          { label: unit ? pick(unit.title, locale) : "8 · Errores y excepciones" },
        ]}
      />
