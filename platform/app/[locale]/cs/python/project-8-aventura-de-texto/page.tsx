...
export const metadata = { title: "Proyecto 8 — Aventura de texto — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  const unit = unitBySlug("project-8-aventura-de-texto");
    ...
    <>
      <Breadcrumbs
        items={[
          ...
          { label: unit ? pick(unit.title, locale) : "Proyecto 8 · Aventura de texto" },
        ]}
      />
