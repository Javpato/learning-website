...
export const metadata = { title: "Sprites, animación y sonido (Pygame) — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  const unit = unitBySlug("pygame-5-sprites-y-sonido");
    ...
    <>
      <Breadcrumbs
        items={[
          ...
          { label: unit ? pick(unit.title, locale) : "Pygame 5 · Sprites y sonido" },
        ]}
      />
