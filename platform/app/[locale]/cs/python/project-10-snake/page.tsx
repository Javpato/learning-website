...
export const metadata = { title: "Proyecto 10 — Snake (Pygame) — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  const unit = unitBySlug("project-10-snake");
    ...
    <>
      <Breadcrumbs
        items={[
          ...
          { label: unit ? pick(unit.title, locale) : "Proyecto 10 · Snake" },
        ]}
      />
