...
export const metadata = { title: "Proyecto 4 — Inventario y tienda — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  const unit = unitBySlug("project-4-inventario-y-tienda");
    ...
    <>
      <Breadcrumbs
        items={[
          ...
          { label: unit ? pick(unit.title, locale) : "Proyecto 4" },
        ]}
      />
