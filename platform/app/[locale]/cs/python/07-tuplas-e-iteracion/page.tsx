...
export const metadata = { title: "Tuplas e iteración — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  const unit = unitBySlug("07-tuplas-e-iteracion");
    ...
    <>
      <Breadcrumbs
        items={[
          ...
          { label: unit ? pick(unit.title, locale) : "7 · Tuplas e iteración" },
        ]}
      />
