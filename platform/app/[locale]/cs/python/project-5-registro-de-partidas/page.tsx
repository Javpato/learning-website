...
export const metadata = { title: "Proyecto 5 — Registro de partidas — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  const unit = unitBySlug("project-5-registro-de-partidas");
    ...
    <>
      <Breadcrumbs
        items={[
          ...
          { label: unit ? pick(unit.title, locale) : "Proyecto 5" },
        ]}
      />
