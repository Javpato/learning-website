...
export const metadata = { title: "Construye tu propia app de datos — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  const unit = unitBySlug("19-construye-tu-propia-app");
    ...
    <>
      <Breadcrumbs
        items={[
          ...
          { label: unit ? pick(unit.title, locale) : "CRUD" },
        ]}
      />
