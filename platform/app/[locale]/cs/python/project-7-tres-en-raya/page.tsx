...
export const metadata = { title: "Proyecto 7 — Tres en raya — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  const unit = unitBySlug("project-7-tres-en-raya");
    ...
    <>
      <Breadcrumbs
        items={[
          ...
          { label: unit ? pick(unit.title, locale) : "Proyecto 7 · Tres en raya" },
        ]}
      />
