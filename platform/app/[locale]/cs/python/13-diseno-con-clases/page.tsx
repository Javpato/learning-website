...
export const metadata = { title: "Diseño con clases — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  const unit = unitBySlug("13-diseno-con-clases");
    ...
    <>
      <Breadcrumbs
        items={[
          ...
          { label: unit ? pick(unit.title, locale) : "13 · Diseño con clases" },
        ]}
      />
