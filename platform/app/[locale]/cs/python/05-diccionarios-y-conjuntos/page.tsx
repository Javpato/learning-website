...
export const metadata = { title: "Diccionarios y conjuntos — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  const unit = unitBySlug("05-diccionarios-y-conjuntos");
    ...
    <>
      <Breadcrumbs
        items={[
          ...
          { label: unit ? pick(unit.title, locale) : "Diccionarios y conjuntos" },
        ]}
      />
