...
export const metadata = { title: "Dibujar en pantalla (Pygame) — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  const unit = unitBySlug("pygame-2-dibujar");
    ...
    <>
      <Breadcrumbs
        items={[
          ...
          { label: unit ? pick(unit.title, locale) : "Pygame 2 · Dibujar" },
        ]}
      />
