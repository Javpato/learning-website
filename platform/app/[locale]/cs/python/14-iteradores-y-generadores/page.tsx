...
export const metadata = { title: "Iteradores y generadores — Learning" };
...
export default function Page({ params }: { params: { locale: string } }) {
  ...
  const unit = unitBySlug("14-iteradores-y-generadores");
    ...
    <>
      <Breadcrumbs
        items={[
          ...
          { label: unit ? pick(unit.title, locale) : "14 · Iteradores y generadores" },
        ]}
      />
